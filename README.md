...
# 👋 Hola, soy xFraZk
¡Hola! Me alegra saber que te apasiona la programación y el desarrollo web, y que estás interesado en desarrollar aplicaciones para Discord. Como principiante en HTML, te sugiero que continúes aprendiendo y practicando para mejorar tus habilidades en este lenguaje y otros que puedan ser relevantes para el desarrollo de aplicaciones web.

Es genial que tu principal objetivo sea crear cosas simples que puedan ser utilizadas y compartidas por todos. Esto demuestra que tienes una mentalidad inclusiva y que te preocupa que tus aplicaciones sean accesibles para todos, lo cual es un valor muy importante en la comunidad de desarrollo.
